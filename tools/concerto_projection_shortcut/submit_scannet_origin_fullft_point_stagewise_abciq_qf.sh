...
LINEAR_CONFIG="${WORKDIR}/data/runs/scannet_semseg_origin/exp/scannet-ft-origin-e800/config.py"
LINEAR_WEIGHT="${WORKDIR}/data/runs/scannet_semseg_origin/exp/scannet-ft-origin-e800/model/model_best.pth"
OUTPUT_DIR="${WORKDIR}/tools/concerto_projection_shortcut/results_scannet_origin_fullft_point_stagewise_trace"

echo "=== ScanNet origin full-FT point stagewise trace ==="
...
echo "[done] ScanNet origin full-FT point stagewise trace"
