...
for var in \
  WORKDIR REPO_ROOT DATASET_NAME CONFIG_NAME EXP_NAME WEIGHT_PATH \
  ...
  COORD_PRIOR_PATH COORD_PROJECTION_ALPHA PYTORCH_CUDA_ALLOC_CONF \
  CONCERTO_GLOBAL_BATCH_SIZE CONCERTO_GRAD_ACCUM CONCERTO_NUM_WORKER \
  CONCERTO_MAX_TRAIN_ITER CONCERTO_EPOCH CONCERTO_ENABLE_FLASH \
