...
SCANNET_IMAGEPOINT_ROOT="${SCANNET_IMAGEPOINT_ROOT:-${DATA_ROOT}/concerto_scannet_imagepoint}"
SCANNET_IMAGEPOINT_META_ROOT="${SCANNET_IMAGEPOINT_META_ROOT:-${DATA_ROOT}/concerto_scannet_imagepoint_absmeta}"
SCANNETPP_COMPRESSED_DIR="${SCANNETPP_COMPRESSED_DIR:-${DATA_ROOT}/concerto_scannetpp_compressed}"
SCANNETPP_IMAGEPOINT_ROOT="${SCANNETPP_IMAGEPOINT_ROOT:-${DATA_ROOT}/concerto_scannetpp_imagepoint}"
SCANNETPP_IMAGEPOINT_META_ROOT="${SCANNETPP_IMAGEPOINT_META_ROOT:-${DATA_ROOT}/concerto_scannetpp_imagepoint_absmeta}"
S3DIS_COMPRESSED_DIR="${S3DIS_COMPRESSED_DIR:-${DATA_ROOT}/concerto_s3dis_compressed}"
S3DIS_IMAGEPOINT_ROOT="${S3DIS_IMAGEPOINT_ROOT:-${DATA_ROOT}/concerto_s3dis_imagepoint}"
S3DIS_IMAGEPOINT_META_ROOT="${S3DIS_IMAGEPOINT_META_ROOT:-${DATA_ROOT}/concerto_s3dis_imagepoint_absmeta}"
HM3D_COMPRESSED_DIR="${HM3D_COMPRESSED_DIR:-${DATA_ROOT}/concerto_hm3d_compressed}"
HM3D_IMAGEPOINT_ROOT="${HM3D_IMAGEPOINT_ROOT:-${DATA_ROOT}/concerto_hm3d_imagepoint}"
HM3D_IMAGEPOINT_META_ROOT="${HM3D_IMAGEPOINT_META_ROOT:-${DATA_ROOT}/concerto_hm3d_imagepoint_absmeta}"
STRUCTURED3D_COMPRESSED_DIR="${STRUCTURED3D_COMPRESSED_DIR:-${DATA_ROOT}/concerto_structured3d_compressed}"
STRUCTURED3D_IMAGEPOINT_ROOT="${STRUCTURED3D_IMAGEPOINT_ROOT:-${DATA_ROOT}/concerto_structured3d_imagepoint}"
STRUCTURED3D_IMAGEPOINT_META_ROOT="${STRUCTURED3D_IMAGEPOINT_META_ROOT:-${DATA_ROOT}/concerto_structured3d_imagepoint_absmeta}"
