...
TRACE_MD="${REPO_ROOT}/tools/concerto_projection_shortcut/results_concerto3d_stagewise_trace_stepA.md"
TRACE_CSV="${REPO_ROOT}/tools/concerto_projection_shortcut/results_concerto3d_stagewise_trace_stepA.csv"
...
cp "${OUT_DIR}/concerto3d_dino_exact_controls_stepA.md" "${TRACE_MD}"
cp "${OUT_DIR}/concerto3d_dino_exact_controls_stepA.csv" "${TRACE_CSV}"
echo "[write] ${SUMMARY_MD}"
echo "[write] ${SUMMARY_CSV}"
echo "[write] ${TRACE_MD}"
echo "[write] ${TRACE_CSV}"
