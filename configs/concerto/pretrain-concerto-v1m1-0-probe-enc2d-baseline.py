...
model = dict(
    ...
    shortcut_probe={"mode": "none", "freeze_student_backbone": False, "zero_color": False, "zero_normal": False, "coord_jitter_std": 0.0, "shuffle_correspondence": False},
)
...
arkit_data_root = "data/arkitscenes"
