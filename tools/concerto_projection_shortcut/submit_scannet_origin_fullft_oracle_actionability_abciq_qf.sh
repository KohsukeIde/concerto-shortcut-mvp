...
CONFIG="${WORKDIR}/data/runs/scannet_semseg_origin/exp/scannet-ft-origin-e800/config.py"
WEIGHT="${WORKDIR}/data/runs/scannet_semseg_origin/exp/scannet-ft-origin-e800/model/model_best.pth"
OUTPUT_DIR="${WORKDIR}/tools/concerto_projection_shortcut/results_scannet_origin_fullft_oracle_actionability"

echo "=== ScanNet origin full-FT oracle actionability ==="
...
echo "[done] ScanNet origin full-FT oracle actionability"
