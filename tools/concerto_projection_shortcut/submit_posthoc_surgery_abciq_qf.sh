...
export RECYCLE_GEOM RECYCLE_SCALE RECYCLE_RIDGE RECYCLE_COEFF_RIDGE RECYCLE_MAX_RANK RECYCLE_COEFF_CLIP
...
echo "gamma=${GAMMA}"
echo "recycle_geom=${RECYCLE_GEOM}"
echo "recycle_scale=${RECYCLE_SCALE}"
echo "recycle_ridge=${RECYCLE_RIDGE}"
echo "recycle_coeff_ridge=${RECYCLE_COEFF_RIDGE}"
echo "recycle_max_rank=${RECYCLE_MAX_RANK}"
echo "recycle_coeff_clip=${RECYCLE_COEFF_CLIP}"
echo "gpus=${GPUS}"
